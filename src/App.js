...
const App = () => {
  return (
    <div>
      <SectionWrapper 
        title="Your own store of Nfty NFTs. Start Selling & Growing." 
      ...
      <SectionWrapper 
        ...
        description="Experience a buttery UI of ProNef NFT Marketplace. Smooth constant 
      ...
      <div className="px-4 py-2 justify-center items-center bg-primary flex-col text-center banner04">
        <p className={`${styles.pText} ${styles.whiteText}`}>Made with love by {" "}  <span className="bold">Javascript Altrono</span></p>
      </div>
    </div>
